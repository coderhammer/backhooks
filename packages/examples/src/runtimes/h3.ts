import { createApp, eventHandler, toNodeListener, getHeaders, readBody } from "h3";
import { listen } from "listhen";
import {configureBodyHook, configureHeadersHook, useHeaders} from "@backhooks/http"
...
app.use(
  "/",
  hookableEventHandler(mainHandler)
);
